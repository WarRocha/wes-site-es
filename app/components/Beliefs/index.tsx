            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 my-16 mx-5 gap-5'>
                ...
                <div className="bg-darkblue bg-beliefs pt-12 px-10 sm:px-24 pb-52 md:pb-70 rounded-3xl">
                    ...
                    <div className="text-center sm:text-start">
                        <button className="text-xl py-5 px-14 mt-5 font-semibold text-white rounded-full bg-blue border border-treetop hover:bg-hoblue">Get Started</button>
                    </div>
                </div>
                ...
                <div className="bg-build pt-12 px-10 sm:px-24 pb-52 md:pb-70 rounded-3xl">
                    <h2 className="text-lg font-normal text-treetop tracking-widest mb-5 text-center sm:text-start">BUILD</h2>
                    <h3 className="text-4xl sm:text-65xl font-bold text-black leading-snug mb-5 text-center sm:text-start"><span className="text-treetop">Build</span> that great idea that you have.</h3>
                    ...
                    <div className="text-center sm:text-start">
                        <button className="text-xl py-5 px-14 mt-5 font-semibold text-white rounded-full bg-blue border border-treetop hover:bg-hoblue">Learn more</button>
                    </div>
                </div>
