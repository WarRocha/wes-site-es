                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-16 mx-5 gap-14 '>
                    {filteredData.map((items, i) => (
                        <div className='manageTabs text-center p-10' key={i}>
                            ...
                            <button className='animate-pulse text-sm font-bold text-EmeraldGreen bg-transparent hover:bg-EmeraldGreen hover:text-white border-2 border-EmeraldGreen rounded-full py-4 px-12 mb-6'>
